...
- pin_list:
  ...
  - {pin_num: B7, peripheral: GPIO0, signal: 'GPIO, 23', pin_signal: PIO0_23/WUU0_IN5/EWM0_OUT_b/FC1_P3/CT_INP3/FLEXIO0_D7/ADC0_A15/CMP2_IN2, direction: INPUT, gpio_per_interrupt: kGPIO_InterruptRisingEdge,
...
void BOARD_InitBUTTONsPins(void)
{
    ...
    /* Interrupt configuration on GPIO0_23 (pin B7): Interrupt on rising edge */
    GPIO_SetPinInterruptConfig(BOARD_INITBUTTONSPINS_SW2_GPIO, BOARD_INITBUTTONSPINS_SW2_PIN, kGPIO_InterruptRisingEdge);

    /* Interrupt configuration on GPIO0_6 (pin C14): Interrupt on rising edge */
    GPIO_SetPinInterruptConfig(BOARD_INITBUTTONSPINS_SW3_GPIO, BOARD_INITBUTTONSPINS_SW3_PIN, kGPIO_InterruptRisingEdge);
